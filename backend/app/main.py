...
@app.delete("/delete-orphan")
def delete_orphan(source: str):
    requirement_ids = list_requirement_ids_by_source(source)

    deleted_actions = delete_actions_by_requirement_ids(requirement_ids)
    deleted_requirements = delete_requirements_by_source(source)
